...
public final void insert(String element) /* Inserts a Node in the Binary Search Tree */
		{
			Node tmp;
		...
		{
			/* This function finds a given element in the tree and returns a variable containing the address of the 
			corresponding node. It also returns a variable containing the address of the parent of the node. */
			currentNode = ROOT;
			parent = null;
