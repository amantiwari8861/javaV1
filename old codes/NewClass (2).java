...
("jdbc:oracle:thin:@localhost:1521:xe","system","1");
   	/*Create a Statement object*/
   	stmt = con.createStatement();
        con.setAutoCommit(false);
        stat = con.prepareStatement("INSERT INTO MY_DAO.PUBLISHERS VALUES(?, ?, ?, ?, ?,?,?)");
  ...
  Class.forName("oracle.jdbc.driver.OracleDriver");
    ...
    Connection con = DriverManager.getConnection
("jdbc:oracle:thin:@localhost:1521:xe","system","1");
stat = con.prepareStatement("UPDATE MY_DAO.PUBLISHERS SET pname = ?,pphone= ?,padd=?,pcity = ?, pstate = ? ,pzip=? where pid = ?");
        String aid = au_idField.getText();
        String aname = au_nameField.getText();
  	String aphone = phoneField.getText();
  	String aadd = addressField.getText(); 
